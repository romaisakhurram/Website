    ...
    return (
        <div className=" w-full h-[500px] bg-[#F2F0FF] items-center mt-10">
            <div className=" w-full h-[500px] flex justify-center">
                ...
                <div className="mt-20 ">
                    <span className="text-[40px] text-[#1A0B5B] font-bold font-serif">Unique Feature Of Leatest & Trending product</span><br />
                    ...
                    <div>
                      <button className="w-40 h-[35px] bg-pink-600 text-white text-[15px]"><Link href="/ShoppingCart">Add to Cart</Link></button>
