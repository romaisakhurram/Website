...
const slides = [
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/images/PinkSofa.png", // Replace with the correct path
  ...
  },
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/images/bluechair.png", // Replace with another chair image
...
export default function Hero() {
  ...
  return (
    <section className="relative bg-purple-50  mt-6 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      {/* Left Column: Lamp */}
