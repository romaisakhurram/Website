...
export default function TrendingProduct() {
  const products = [
    { id: 1, img: "/images/grayChair.png" },
    { id: 2, img: "/images/redChair.png" },
    { id: 3, img: "/images/whiteSofa.png" },
    { id: 4, img: "/images/blackSofa.png" },
  ];

  const exclusiveProducts = [
    { id: 1, img: "/images/chair3.png" },
    { id: 2, img: "/images/chair1.png" },
    { id: 3, img: "/images/chair2.png" },
  ];
    ...
    View Collection
        ...
        <div className="flex flex-col space-y-4">
          {exclusiveProducts.map((product) => (
            <div
              key={product.id}
              className="bg-gray-200 flex items-center p-4  w-[300px] h-[55px] rounded shadow"
            >
              <Image
                src={product.img}
              ...
              ></Image>
              <div>
                <h3 className="text-[#3F509E] font-semibold text-[15px] mb-1">Exclusive Seat Chair</h3>
